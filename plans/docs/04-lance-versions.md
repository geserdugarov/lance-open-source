...
| **Lance v9** | *(in beta)* | `9.0.0-beta.10` | — | Current `main`; unequal-length columns in v2 files; MemWAL & distributed scalar index work |
...
Current `main` (`9.0.0-beta.N`). The major bump so far comes from renaming
`FMIndexIndexDetails` to `FMIndexDetails` (#7397). In flight: v2 file
writer/reader support for columns of unequal length (#7406), distributed
LabelList scalar index builds (#7223), continued MemWAL work. Everything here
is preview-only until `v9.0.0` passes a vote.
